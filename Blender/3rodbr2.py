...
for i in range(len(rod1_listx[0])):
    spheres1.append(Sphere((rod1_listx[0][i],rod1_listy[0][i],rod1_listz[0][i])))
    spheres2.append(Sphere((rod2_listx[0][i],rod2_listy[0][i],rod2_listz[0][i])))
    spheres3.append(Sphere((rod3_listx[0][i],rod3_listy[0][i],rod3_listz[0][i])))

cylinders1 = []
cylinders2 = []
cylinders3 = []
for i in range(len(spheres1)-1):
    cylinders1.append(Cylinder(spheres1[i].obj.location, spheres1[i+1].obj.location))
    cylinders2.append(Cylinder(spheres2[i].obj.location, spheres2[i+1].obj.location))
    cylinders3.append(Cylinder(spheres3[i].obj.location, spheres3[i+1].obj.location))


#so this needs to be pretty reworked
for time_step in range(len(rod1_listx)):
    for s in range (len(spheres1)):
        spheres1[s].update_position(rod1_listx[time_step][s], rod1_listy[time_step][s], rod1_listz[time_step][s])
        spheres1[s].obj.keyframe_insert(data_path="location", frame=time_step)
        spheres2[s].update_position(rod2_listx[time_step][s], rod2_listy[time_step][s], rod2_listz[time_step][s])
        spheres2[s].obj.keyframe_insert(data_path="location", frame=time_step)
        spheres3[s].update_position(rod3_listx[time_step][s], rod3_listy[time_step][s], rod3_listz[time_step][s])
        spheres3[s].obj.keyframe_insert(data_path="location", frame=time_step)
        
    for c in range (len(cylinders1)):
        depth, center, angles = cylinders1[c].calc_cyl_orientation(spheres1[c].obj.location, spheres1[c+1].obj.location)
        ...
        cylinders1[c].obj.keyframe_insert(data_path="rotation_euler", frame=time_step)
        cylinders1[c].obj.keyframe_insert(data_path="scale", frame=time_step)
        
        depth, center, angles = cylinders2[c].calc_cyl_orientation(spheres2[c].obj.location, spheres2[c+1].obj.location)
        ...
        cylinders2[c].obj.keyframe_insert(data_path="rotation_euler", frame=time_step)
        cylinders2[c].obj.keyframe_insert(data_path="scale", frame=time_step)
        
        depth, center, angles = cylinders3[c].calc_cyl_orientation(spheres3[c].obj.location, spheres3[c+1].obj.location)
        ...
        cylinders3[c].obj.keyframe_insert(data_path="rotation_euler", frame=time_step)
