...
class TwoGCRSimulation(DualArmSimulationBase):
    ...
    def build_simulation(self) -> None:
        ...
        from virtual_field.runtime.custom_elastica.boundary_conditions import (
            _GrowingCRBoundaryConditions,
        )
        from virtual_field.runtime.custom_elastica.rods.growing_cr import GrowingCR
